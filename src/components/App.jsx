  ...
  return (
    <div>
      <Profile
        ...
        tag={userInform.tag}
        location={userInform.location}
        avatar={userInform.avatar}
        followers={userInform.stats.followers}
        views={userInform.stats.views}
        likes={userInform.stats.likes}
      />
      <Statistics stats={data} />
      <FriendListItem status={userOnlOrOfl} />
